...
-- 8. mostrar el codigo, fecha de ingreso y horas de vacaciones de los empleados ingresaron a partir del a�o 2000 
select	*
from	HumanResources.Employee
where	HireDate > '2000-01-01'

-- listar los empleados que ingresaron entre los a�os 1990 y 2000
select	*
from	HumanResources.Employee
...
-- 14. mostrar la fecha,numero de version y subtotal de las ventas efectuadas en los a�os 2005 y 2006 
...
select ps.Name, ListPrice
from Production.Product p 
join Production.ProductSubcategory ps on p.ProductSubcategoryID = ps.ProductSubcategoryID
where ListPrice between 1000 and 1200 and ps.Name like '%Mountain Bike%'
...
-- 20. mostrar el nombre concatenado con el apellido de las personas cuyo apellido tengan terminacion espa�ola (ez)
...
select SalesOrderID as Factura,
Count(SalesOrderID) As CantidadFacturas
	from Sales.SalesOrderDetail
		group by SalesOrderID
...
--54. mostrar el producto mas barato de cada subcategor�a. mostrar subcategoria, codigo de producto y el precio de lista mas barato ordenado por subcategoria 
...
--66. listar los productos cuyos precios de venta sean mayores o iguales que el precio de venta m�ximo de cualquier subcategor�a de producto. Por subconsulta con operador >=ANY
...
67.listar el nombre de los productos, el nombre de la subcategoria a la que pertenece junto a su categor�a de precio. La categor�a de precio se calcula de la siguiente manera. 
	...
	-si la categor�a est� entre 1001 y 2000, normal 
...
CREATE FUNCTION A�oIngresoEmpleados (@a�o int)
RETURNS TABLE
AS
	RETURN
	(
...
--uso de la funcion
SELECT * FROM dbo.A�oIngresoEmpleados(2004)-- 45
SELECT * FROM dbo.A�oIngresoEmpleados(2000)-- 1
...
--91: Crear una  funci�n llmada "ofertas" que reciba un par�metro correspondiente a un precio y nos retorne una 
tabla con c�digo,nombre, color y precio de todos los productos cuyo precio sea inferior al par�metro ingresado
